...
class BeverageAdapter(context: Context, resource: Int) : ArrayAdapter<Category>(context, resource) {
    ...
    override fun getView(
        ...
        val textView: TextView = view.findViewById(R.id.beverageTextView)
